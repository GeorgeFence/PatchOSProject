...
namespace PatchOS.Files
{
    public static class DataUtils
    {
        ...
        public static char StringToChar(string val)
        {
            ...
            {
                CLI.Write("[ERROR] ", ColorFile.Red); CLI.WriteLine("Could not convert value \"" + val + "\" to char.");
                CLI.Write("[DEBUG INFO] ", ColorFile.Yellow); CLI.WriteLine(ex.Message, ColorFile.Gray);
            }
            return c;
        }
        ...
        public static int StringToInt(string val)
        {
            ...
            {
                CLI.Write("[ERROR] ", ColorFile.Red); CLI.WriteLine("Could not convert value \"" + val + "\" to byte.");
                CLI.Write("[DEBUG INFO] ", ColorFile.Yellow); CLI.WriteLine(ex.Message, ColorFile.Gray);
            }
            return output;
        }
