...
namespace PatchOS.Files.Drivers.GUI
{
    public static class ASC16
    {
        ...
        public static void DrawACSIIString(Canvas vbe, string s, System.Drawing.Color color, uint x, uint y)
        {
                ...
                for (int c = 0; c < lines[l].Length; c++)
                {
                    ...
                    for (int i = 0; i < 16; i++)
                    {
                        for (int j = 0; j < 8; j++)
                        {
                            ...
                            {
                                vbe.DrawFilledRectangle(color,(int)((x + j) + (c * 8)), (int)(y + i + (l * 16)), 1, 1);
                            }
                        }
                    }
                }
        ...
        public static void DrawACSIIString(Canvas vbe, string s, System.Drawing.Color color, uint x, uint y, System.Drawing.Color BackGround)
        {
            vbe.DrawFilledRectangle(BackGround,(int)x, (int)y, (ushort)(8 * s.Length), 16);
            string[] lines = s.Split('\n');
            for (int l = 0; l < lines.Length; l++)
            {
                for (int c = 0; c < lines[l].Length; c++)
