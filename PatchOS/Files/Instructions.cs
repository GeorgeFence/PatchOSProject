...
namespace PatchOS.Files
{
    public static class Instructions
    {
        ...
        public static ColorFile ByteToColor(byte b) { int data = b; return (ColorFile)data; }
        ...
        public static bool F_RAND()
        {
            ...
            catch (Exception ex)
            {
                ...
                CLI.Write("[FATAL] " + ColorFile.Red); CLI.WriteLine(ex.Message, ColorFile.White);
            }
            return true;
        }
        ...
        public static bool F_PIX()
        {
            ...
            if (col > 0xF) { col = 0xF; }
            TextGraphics.SetPixel(xx, yy, (ColorFile)col);
        ...
        public static bool F_PIXR()
        {
            ...
            {  TextGraphics.SetPixel(xx, yy, (ColorFile)CPU.Registers[r]); }
            else { TextGraphics.SetPixel(xx, yy, ColorFile.White); }
        ...
        public static bool F_PIXA()
        {
            ...
            if (col > 0xF) { col = 0xF; }
            TextGraphics.SetPixel(CPU.Registers[rx], CPU.Registers[ry], (ColorFile)col);
        ...
        public static bool F_PIXAR()
        {
            ...
            byte ry = Memory.Read((ushort)(CPU.ProgCtr + 3));
            if (CPU.Registers[r] <= 0xF)
            { TextGraphics.SetPixel(CPU.Registers[rx], CPU.Registers[ry], (ColorFile)CPU.Registers[r]); }
            else { TextGraphics.SetPixel(CPU.Registers[rx], CPU.Registers[ry], ColorFile.White); }
